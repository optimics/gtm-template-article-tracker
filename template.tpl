...
injectScript(
  data.staging ? ('https://storage.googleapis.com/zt-le-scripts/at/staging/main.js?cacheBreak=' + getTimestampMillis()) : 'https://storage.googleapis.com/zt-le-scripts/at/0.7.1/main.js',
  connectTracking,
  data.gtmOnFailure,
  'article-tracker'
);
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://storage.googleapis.com/zt-le-scripts/at/0.7.1/main.js"
              },
              {
                "type": 1,
